...
extern void X86CALL x86_poly_filter(const F32 FAR *src,
                                    const F32 FAR *b,
                                    S32            phase,
                                    F32       FAR *out1,
                                    F32       FAR *out2);

extern void X86CALL x86_dewindow_and_write(F32 FAR *u,
                                           F32 const FAR *dewindow,
                                           S32      start,
                                           S16 FAR *samples,
                                           S32      output_step,
                                           S32      div);

extern void X86CALL AMD_poly_filter(const F32 FAR *src,
                                    const F32 FAR *b,
                                    S32            phase,
                                    F32       FAR *out1,
                                    F32       FAR *out2);

extern void X86CALL AMD_dewindow_and_write(F32 FAR *u,
                                           F32 const FAR *dewindow,
                                           S32      start,
                                           S16 FAR *samples,
                                           S32      output_step,
...
extern void X86CALL SSE_dewindow_and_write(F32 FAR *u,
                                           F32 const FAR *dewindow,
                                           S32      start,
                                           S16 FAR *samples,
                                           S32      output_step,
...
extern void X86CALL x86_IMDCT_3x12        (F32 FAR *in,
                                           S32      sb,
                                           F32 FAR *result,
                                           F32 FAR *save);

extern void X86CALL AMD_IMDCT_3x12        (F32 FAR *in,
                                           S32      sb,
                                           F32 FAR *result,
                                           F32 FAR *save);

extern void X86CALL x86_IMDCT_1x36        (F32 FAR *in,
                                           S32      sb,
                                           F32 FAR *result,
                                           F32 FAR *save,
                                           F32 FAR *window);

extern void X86CALL AMD_IMDCT_1x36        (F32 FAR *in,
                                           S32      sb,
                                           F32 FAR *result,
                                           F32 FAR *save,
                                           F32 FAR *window);
...
extern void PS2_poly_filter(const F32 FAR *src,
                          const F32 FAR *b,
                          S32            phase,
                          F32       FAR *out1,
                          F32       FAR *out2);

extern void PS2_dewindow_and_write(F32 FAR *u,
                                   const F32 FAR *dewindow,
                                   S32      start,
                                   S16 FAR *samples,
                                   S32      output_step,
                                   S32      div);

extern void PS2_IMDCT_3x12(F32 FAR *in,
                         S32      sb,
                         F32 FAR *result,
                         F32 FAR *save);

extern void PS2_IMDCT_1x36(F32 FAR *in,
                         S32      sb,
                         F32 FAR *result,
                         F32 FAR *save,
                         F32 FAR *window);
...
extern void AILCALL PPC_poly_filter(const F32 FAR *src,
                                    const F32 FAR *b,
                                    S32            phase,
                                    F32       FAR *out1,
                                    F32       FAR *out2);

extern void AILCALL PPC_dewindow_and_write(F32 FAR *u,
                                           F32 FAR *dewindow,
                                           S32      start,
                                           S16 FAR *samples,
                                           S32      output_step,
...
extern void AILCALL PPC_IMDCT_3x12    (F32 FAR *in,
                                       S32      sb,
                                       F32 FAR *result,
                                       F32 FAR *save);

extern  void AILCALL PPC_IMDCT_1x36    (register F32 FAR *input,
                                        register S32      sb,
                                        register F32 FAR *result,
                                        register F32 FAR *last,
                                        register F32 FAR *window);
...
inline U32 view_bits8(U8 FAR *data, S32 bitpos)
{
   U32 val;
...
static __inline U32 read_bits(U8 FAR *data, S32 *bitpos, S32 n)
{
   U32 val;
   S32     b = *bitpos;
...
static __inline U32 view_bits8(U8 FAR *data, S32 bitpos)
{
   U32 val;
