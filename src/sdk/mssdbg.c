...
#define ailcall17(header,func,type,param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13,param14,param15,param16,param17) \
          header##_API_##func(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13,param14,param15,param16,param17)
...
#if !defined(IS_WII) && !defined(IS_XENON) && !defined(IS_PS3)  // These platforms modify channel_spec themselves
                                             ...
                                             U32     flags)
{
   ...
   result=dsailcall3(AIL,init_sample,void,S,format,flags);
                                                      ...
                                                      S32                    n_levels)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_sample_channel_levels(" PTRFMT "," PTRFMT "," PTRFMT "," PTRFMT ",%d)" NL,
         S,source_speaker_indexes, dest_speaker_indexes, levels,n_levels);
      }

   IN_AIL;

   dsailcall5(AIL,set_sample_channel_levels,void,S,source_speaker_indexes, 
                                                  ...
                                                  S32                    n_levels)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_channel_levels(" PTRFMT "," PTRFMT "," PTRFMT "," PTRFMT ",%d)" NL,
         S,source_speaker_indexes, dest_speaker_indexes, levels,n_levels);
      }

   IN_AIL;

   dsailcall5(AIL,sample_channel_levels,void,S,source_speaker_indexes, 
                                               dest_speaker_indexes,
                                               levels,
                                               n_levels);
...
//############################################################################
DXDEF  
void         AILEXPORT AIL_sample_output_levels (HSAMPLE                S, //)
                                                  MSS_SPEAKER FAR const *source_speaker_indexes,
                                                  MSS_SPEAKER FAR const *dest_speaker_indexes,
                                                  F32 FAR               *levels,
                                                  S32                    n_levels)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_output_levels(" PTRFMT "," PTRFMT "," PTRFMT "," PTRFMT ",%d)" NL,
         S,source_speaker_indexes, dest_speaker_indexes, levels,n_levels);
      }

   IN_AIL;

   dsailcall5(AIL,sample_output_levels,void,S,source_speaker_indexes, 
                                               dest_speaker_indexes,
                                               levels,
                                               n_levels);
                                               ...
                                               S32          n_levels)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_speaker_reverb_levels(" PTRFMT "," PTRFMT "," PTRFMT "," PTRFMT ",%d)" NL,dig,wet_array,dry_array,speaker_array,n_levels);
      }

   IN_AIL;

   dsailcall5(AIL,set_speaker_reverb_levels,void,dig,wet_array,dry_array,speaker_array,n_levels);
                                             ...
                                             MSS_SPEAKER FAR const * FAR *speaker_array)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_speaker_reverb_levels(" PTRFMT "," PTRFMT "," PTRFMT "," PTRFMT ")" NL,dig,wet_array,dry_array,speaker_array);
      }

   IN_AIL;

   result = dsailcall4(AIL,speaker_reverb_levels,void,dig,wet_array,dry_array,speaker_array);
                                                      ...
                                                      F32                         *doppler_shift)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_calculate_3D_channel_levels(" PTRFMT "," PTRFMT "," PTRFMT "," PTRFMT "," PTRFMT "," PTRFMT ",%s,%s,%s,%s,%s," PTRFMT "," PTRFMT "," PTRFMT ",%s," PTRFMT ",%s)" NL,
         dig,
         channel_levels,    
         speaker_array,
         src_pos,           
   ...
   result = dsailcall17(AIL,calculate_3D_channel_levels,S32,
         dig,
         channel_levels,    
         speaker_array,
         src_pos,           
...
S32     AILEXPORT AIL_sample_buffer_available  (HSAMPLE S)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_buffer_available(" PTRFMT ")" NL,S);
      }

   IN_AIL_NM;

   result=dsailcall1(AIL,sample_buffer_available,S32,S);
...
S32     AILEXPORT AIL_sample_buffer_count       (HSAMPLE S)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_buffer_count(" PTRFMT ")" NL,S);
      }

   IN_AIL_NM;

   result=dsailcall1(AIL,sample_buffer_count,S32,S);
                                               ...
                                               S32     n_buffers)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_sample_buffer_count(" PTRFMT ")" NL,S);
      }

   IN_AIL;

   result=dsailcall2(AIL,set_sample_buffer_count,S32,S,n_buffers);
                                               ...
                                               U32     len)
{
   ...
   result=dsailcall4(AIL,load_sample_buffer,void,S,buff_num,buffer,len);
            ...
            S32     FAR *tail)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_buffer_info(" PTRFMT ",%ld," PTRFMT "," PTRFMT "," PTRFMT "," PTRFMT ")" NL,
                 S,buff_num,pos,len,head,tail);
      }

   IN_AIL;

   result=dsailcall6(AIL,sample_buffer_info,S32,S,buff_num,pos,len,head,tail);
                                                 ...
                                                 U32    *mask)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_channel_count(" PTRFMT "," PTRFMT ")" NL,S,mask); 
      }

   IN_AIL_NM;

   result=dsailcall2(AIL,sample_channel_count,S32,S,mask);
