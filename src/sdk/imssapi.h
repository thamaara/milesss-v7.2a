...
extern void         AILCALL AIL_API_set_speaker_reverb_levels
                                                      (HDIGDRIVER       dig, 
                                                       F32 FAR         *wet_array,
                                                       F32 FAR         *dry_array,
                                                       MSS_SPEAKER FAR *speaker_index_array,
                                                       S32              n_levels);
...
extern void     AILCALL AIL_API_sample_output_levels  (HSAMPLE                S, 
                                                       MSS_SPEAKER FAR const *source_speaker_indexes,
                                                       MSS_SPEAKER FAR const *dest_speaker_indexes,
                                                       F32 FAR               *levels,
                                                       S32                    n_levels);
...
extern S32 AILCALL SS_set_sample_type( HSAMPLE S, S32 format, U32 flags, U32 channel_mask );
