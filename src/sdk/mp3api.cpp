...
#ifndef IS_DOS
   EMITTED_SAMPLE_COUNT,    // S64 * to store # of samples emitted since last seek/rewind
#endif
...
#ifndef IS_DOS
         STR->emitted_sample_count += (avail >> STR->nch);
#endif
...
#ifndef IS_DOS
      case EMITTED_SAMPLE_COUNT:
        if (before_value) 
        {
          *(S64 FAR *) before_value = STR->emitted_sample_count;
          return 1;
        }
        break;
#endif
...
DXDEF S32 AILEXPORT RIB_MAIN_NAME(MP3Dec)( HPROVIDER provider_handle, U32 up_down )
{
    ...
    const RIB_INTERFACE_ENTRY ASISTR6[] =
      {
#ifndef IS_DOS
      REG_PR("Emitted samples",          EMITTED_SAMPLE_COUNT, (RIB_DATA_SUBTYPE) (RIB_READONLY|RIB_CUSTOM)),
#endif
